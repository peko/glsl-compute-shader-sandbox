...
void main() {
  ...
  if (int(type)==0) base_color = vec4(0.9, 0.0, 0.2, 1.0); 
  if (int(type)==1) base_color = vec4(1.0, 0.5, 0.3, 1.0); 
  if (int(type)==2) base_color = vec4(1.0, 0.9, 0.1, 1.0); 
  if (int(type)==3) base_color = vec4(0.3, 0.7, 0.0, 1.0);
  if (int(type)==4) base_color = vec4(0.0, 0.5, 0.8, 1.0);
  if (int(type)==5) base_color = vec4(0.3, 0.0, 0.6, 1.0);
